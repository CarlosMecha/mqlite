...
var _selectStmt = 'SELECT uuid, timestamp, format, topic, payload FROM messages WHERE topic = ? ORDER BY timestamp ASC LIMIT ?';
...
Connection.prototype._createSchema = function(callback) {
    this._db.exec(_schema, callback);
};
